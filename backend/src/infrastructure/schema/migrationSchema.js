/**
 * Database schema from migration.sql
 * Embedded as a constant string to avoid filesystem access issues on Railway.
 * 
 * This file contains the exact content of DB/migration.sql.
 * DO NOT modify the SQL content - only update when migration.sql changes.
 */
export const MIGRATION_SCHEMA = `create extension if not exists pg_cron;
